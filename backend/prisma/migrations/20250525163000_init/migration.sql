...
-- CreateEnum
CREATE TYPE "ProductSize" AS ENUM ('ML_300', 'ML_500', 'ML_700', 'ML_1000');
...
CREATE TABLE "Product" (
    ...
    "freeToppingsLimit" INTEGER NOT NULL DEFAULT 3,
    "mainImageUrl" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ProductAddon" (
    ...
    "name" TEXT NOT NULL,
    "price" DECIMAL(10,2) NOT NULL,
    "countsTowardFree" BOOLEAN NOT NULL DEFAULT true,
    "maxPerOrder" INTEGER,
...
-- CreateIndex
CREATE INDEX "ProductSizePrice_productId_idx" ON "ProductSizePrice"("productId");

-- CreateIndex
CREATE UNIQUE INDEX "ProductSizePrice_productId_size_key" ON "ProductSizePrice"("productId", "size");
